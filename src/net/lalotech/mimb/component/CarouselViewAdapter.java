package net.lalotech.mimb.component;
/*
...
import android.widget.Filter;
 ...
 public class CarouselViewAdapter extends BaseAdapter {
    ...
    private int mReflection_part = 4; //4
    private int mReflectionGap = 0; //0
	...
	private Bitmap createReflectedImage(Bitmap bmp) {
		...
		final int reflectionGap = mReflectionGap;
    	...
    	int reflection_part = mReflection_part;
